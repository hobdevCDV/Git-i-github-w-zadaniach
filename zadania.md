...
### Zadanie 2.
W serwisie GitHub utwórz trzy konta użytkownika:
- konto, z którego będziesz korzystać w ramach całego kursu i być może swojej dalszej pracy z serwisem (konto deweloperskie)
- konto pomocnicze, z którego będziemy korzystać na etapie pracy z gałęziami w ramach jednej organizacji (konto współpracownicze)
- konto pomocnicze, które będzie nam potrzebne na etapie omawiania problemów (Issues) i odgałęzień (Forks) (konto obserwatorskie).
...
### Zadanie 4. 
W ramach kursu zajmiemy się projektem struktury małej gastronomii pizzerii inspirowanej postacią Leonarda da Vinci. Załóż pierwsze repozytorium: 
- utwórz repozytorium i nadaj mu nazwę,
- wybierz licencję, 
- skonfiguruj opis i utwórz plik README.

---

### Zadanie 5. 
Projekt pizzerii ma składać się z:
- pliku w formacie .md z opisem Twojej pizzerii
- pliku w formacie .md z treścią menu
- pliku w formacie .md ze szczegółowymi przepisami dań z menu
- pliku w formacie .md z prezentacją zespołu 
- pliku w formacie .md z adresem i szczegółami kontaktowymi
- katalogu z ciekawymi grafikami do wykorzystania na stronie pizzerii
W ostatnich zadaniach kursu do projektu dodamy jeszcze stronę internetową oraz stronę wiki.

Korzystając z funkcjonalności GitHub Projects, utwórz plan swojego projektu. Sprawdź dostępne szablony. Na potrzeby obecnego projektu skorzystaj z szablonu tablicy zadań i zaplanuj swoją pracę z uwzględnieniem wymagań przedstawionych powyżej. 
...
### Zadanie 7.
Cofnij swoje repozytorium w serwisie GitHub do dowolnego wcześniejszego stanu.
